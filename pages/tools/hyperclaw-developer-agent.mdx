...
Use the dedicated setup guide if you want that exact path:

- [OpenClaw GPT-5.5 Setup](/tools/openclaw-gpt-5-5)
...
Use this checklist before calling the agent ready.

- [ ] Agent has a name and role
- [ ] `SOUL.md` captures voice and operating style
- [ ] `IDENTITY.md` captures stable agent facts
- [ ] `USER.md` captures owner/team preferences
- [ ] `TOOLS.md` captures local environment notes
- [ ] `MEMORY.md` exists for durable memory
- [ ] Default model is configured and verified
- [ ] Model setup survives restart
- [ ] GitHub token or PR workflow is available
- [ ] Publishing path works with a test page
- [ ] Repo clone, edit, commit, and PR flow has been tested
- [ ] At least one setup lesson has been written to memory
