...
- [ ] `brain/wiki/` directory created with at least one document
- [ ] Category resolver in `brain/categories/README.md`
- [ ] G-Brain installed and index initialized
- [ ] Embeddings proxy running
- [ ] `gbrain search` returns relevant results for a test query
- [ ] Chat-based query retrieves the right document and gives a grounded answer
